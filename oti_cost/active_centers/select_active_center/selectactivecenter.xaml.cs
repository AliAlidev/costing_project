...
namespace oti_cost.active_centers.select_active_center
{
    ...
    public partial class selectactivecenter : Window
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            query = "select * from material_used where project_number=" + projectNum + " and active_center_name='" + active_name.Text + "'" ;
